 ...
 */
public class KratzenParser extends AbstractMarkupLangParser {
    ...
    public Node parse() throws MalformedURLException,
        ...
        /* Check if the source has already been parsed. */
            ...
            this.rootNode = new KratzenNode(this.doc.body());
        }
