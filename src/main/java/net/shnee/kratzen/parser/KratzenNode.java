 ...
 *
 */
public class KratzenNode extends AbstractNode {

    /** Internal data structure of KratzenNode. */
     ...
     */
    public KratzenNode(Element node) { this.node = node; }
    ...
    public List<Node> css(String selection) {
        ...
        for(Element element : elements) {
            nodes.add(new KratzenNode(element));
        }
        return nodes;
    }
    ...
    @Override
    public Node parent() {
        return new KratzenNode(this.node.parent());
    }
